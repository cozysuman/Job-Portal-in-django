...
class EmployeeRegistrationForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['email'].widget.attrs.update(
            {
                'placeholder': 'Enter Email(eg. 072bct500@pcamus.edu.np)',
            }
        )
    ...
    class Meta:
        ...
        error_messages = {
            ...
            'middle_name': {
                ...
                'max_length': 'Middle Name is too long'
            },
            'last_name': {
    ...
    def clean_email(self):
        ...
        if not email.endswith("pcampus.edu.np"):
            raise forms.ValidationError("This is not a valid gmail. Please enter campus gmail(abc@pcamus.edu.np)")
        return email
