...
class Resume(models.Model):
    ...
    middlename = models.CharField(max_length=150, verbose_name=_("Middle name"),blank=True, null=True)
    lastname = models.CharField(max_length=150, verbose_name=_("Last name"))
    user=models.OneToOneField(settings.AUTH_USER_MODEL,related_name='resumes',on_delete=models.CASCADE)
    # user=models.ForeignKey(settings.AUTH_USER_MODEL,related_name='resumes',on_delete=models.CASCADE,unique=True)
    title = models.CharField(max_length=200, blank=True, null=True, verbose_name=_("Your speciality or profession"))
    resume = models.TextField(max_length=3000, blank=True, null=True, verbose_name=_("Short profile's description"))
    image = models.ImageField(upload_to='user_images', blank=True, null=True, verbose_name=_(" Resume Image"))
    ...
    skype = models.CharField(max_length=100, blank=True, null=True, verbose_name=_("LinkedIn"))
